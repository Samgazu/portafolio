...
export const QuoteDescription = () => {
  ...
  const [quotesFinishedItems,] = useState(list);
  const [searchQuotesFinished,] = useState(list);
  const [searchInAllFinishQuote,] = useState(list);
              ...
              <div className={'element'}>
                <div className={'quoteData'}>
                  ...
                  <div className={'elementQuoteData'}>
                    ...
                    <div className={'value'}>{`${quoteFinish.currentDate && dateToQuote
                      }`}</div>
                  </div>
                  <div className={'elementQuoteData'}>
