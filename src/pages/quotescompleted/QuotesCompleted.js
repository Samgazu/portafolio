...
import { getFinishedAllQouteSuccess,  getFinishedQouteSuccess, getUnfinishedQouteSuccess } from "../../actions/systemsAction";
...
export const QuotesCompleted = () => {
  ...
  //const finishedQuotes = useSelector(state => state.systems.quotesFinished)
